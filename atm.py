...
class ATM(Frame):
	...
	def __init__(self, bank):
		"""Initialize the frame, widget and the data model."""
		Frame.__init__(self)
	...
	def _getBalance(self):
		self._statusVar.set("Your balance is $%0.2f" % (self._account.getBalance()))
	...
	def _withdraw(self):
		...
		if message:
			...
			self._statusVar.set("Withdrawl made")
...
#Top-level functions
def main():
	"""Instantiate a Bank and an ATM to run it"""
	bank = Bank("bank.dat")
